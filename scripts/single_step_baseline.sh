...
do
    ...
    do
        ...
        CUDA_DEVICE_ORDER=PCI_BUS_ID python3 ./torch_timeseries/cli/$baseline.py --dataset_type="$dataset" --device="$device" --batch_size=32 --horizon="$horizon" --windows $windows --epochs=100 config_wandb --project=BiSTGNN --name="baseline" runs --seeds='[42,233,666,19971203,19980224]'
    done
done
