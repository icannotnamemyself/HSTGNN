...
class WeightedHANConv(MessagePassing):
    def __init__(
        ...
        **kwargs,
        ...
        for edge_type in metadata[1]:
            ...
            self.edge_att_dict[edge_type] =  nn.Linear(dim +dim+dim, dim)
    ...
    def forward(
        ...
        for edge_type, edge_index in edge_index_dict.items():
            ...
            out = self.propagate(edge_index, x=(x_src, x_dst),edge_weight=edge_weight, size=None, edge_type=edge_type)
    ...
    def message(self, x_j: Tensor,x_i,
    ...
    def update(self, aggr_out, x,edge_type):
        ...
        (x_src, x_dst) = x
        x_src = x_src.view(-1, self.out_channels)
        x_dst = x_dst.view(-1, self.out_channels)
