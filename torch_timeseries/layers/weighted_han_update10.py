...
class WeightedHAN(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self.edge_updte_mlp = nn.ModuleList()
        
        
        
        self.edge_updte_mlp.append(nn.Sequential(
            nn.Linear(edge_in_channel, edge_channel),
            nn.ReLU(),
            nn.Linear(edge_channel, edge_channel)
        ))
    ...
    def forward(self, x, edge_index, edge_attr):
        ...
        for i in range(self.num_layers):
            ...
            for bi in range(x.shape[0]):
                ...
                out_dict,out_att,edge_weight_dict = self.convs[i](x_dict, edge_index_dict,edge_weight_dict)
...
class WeightedHANConv(MessagePassing):
    ...
    def forward(
        ...
        edge_weight_dict:Dict[EdgeType, Adj],
                                                ...
                                                Dict[NodeType, OptTensor]] ,Dict[NodeType, OptTensor]]:
        H, D = self.heads, self.out_channels // self.heads
        x_node_dict, out_dict, edge_weight_dict_out = {}, {}, {}
        ...
        for edge_type, edge_index in edge_index_dict.items():
            ...
            edge_weight_dict_out[edge_type] = edge_weight
        ...
        return out_dict, semantic_attn_dict, edge_weight_dict_out
