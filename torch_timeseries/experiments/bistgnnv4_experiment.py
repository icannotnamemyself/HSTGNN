...
from torch_timeseries.models import  BiSTGNNv4
...
@dataclass
class BiSTGNNv4Experiment(Experiment):
    model_type: str = "BiSTGNNv4"
    
    remain_prob:float=1.0
    gcn_type:str='han'
    graph_build_type:str='adaptive'
    output_layer_type:str='tcn4'
