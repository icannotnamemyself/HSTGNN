...
class TNModule(nn.Module):
    def __init__(
        ...
        if graph_build_type == "adaptive":
            ...
            self.graph_constructor = STGraphConstructor(predefined_adj)
        elif graph_build_type == "fully_connected":
            self.graph_constructor = STGraphConstructor(predefined_adj=None, adaptive=False)
...
class STGraphConstructor(nn.Module):
    def __init__(self, predefined_adj=None, adaptive=True):
