...
from torch_timeseries.layers.tcn_output2 import TCNOuputLayer
...
class BiSTGNNv5(nn.Module):
    def __init__(
        ...
        if rebuild_time:
            out_channels = out_channels + 1
        if self.output_layer_type == 'tcn2':
        ...
        elif self.output_layer_type == 'tcn3':
            self.output_layer = TCNOuputLayer3(
                input_seq_len=seq_len,
                out_seq_len=self.out_seq_len,
                tcn_layers=tcn_layers,
                dilated_factor=dilated_factor,
        ...
        elif self.output_layer_type == 'tcn4':
            ...
            raise NotImplementedError("output layer type {} not implemented".format(self.output_layer_type))
